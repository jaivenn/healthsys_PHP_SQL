...
//244574700_322087779604661_8207402889226768946_n
  ...
  if($status) {
    try {
      ...
      $query = "INSERT INTO `users`(`display_name`, `username`, `password`, `role`, `profile_picture`) 
...
$queryUsers = "SELECT `id`, `display_name`, `user_name`, `role`, `profile_picture`
FROM `users`
         ...
         <tbody>
          ...
          while($row = $stmtUsers->fetch(PDO::FETCH_ASSOC)) {
           ...
           <tr>
             ...
             <td class="px-2 py-1 align-middle"><?php echo $row['role'];?></td>
