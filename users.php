...
if (isset($_POST['save_user'])) {
  ...
  if ($status) {
    try {
      ...
      $query = "INSERT INTO `users`(`name`, `username`, `password`, `role`, `profile_picture`) 
      VALUES('$displayName', '$userName', '$encryptedPassword', '$role', '$targetFile');";
...
$queryUsers = "SELECT `id`, `name`, `username`, `user_type`, `profile_picture`
FROM `users`
ORDER BY `name` ASC;";
$stmtUsers = '';
            ...
            <form method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                  ...
                  <select id="role" name="role" required="required" class="form-control form-control-sm rounded-0">
                ...
                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
                  <label>&nbsp;</label>
                  <button type="submit" id="save_medicine" name="save_user" class="btn btn-primary btn-sm btn-flat btn-block">Save</button>
                </div>
              </div>
            </form>
          </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="px-2 py-1 align-middle"><?php echo $row['user_type']; ?></td>
