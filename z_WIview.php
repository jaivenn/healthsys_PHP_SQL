...
<body>
  ...
  <div id ="SideBarBG">
    ...
    <ul id="sideBarNavCon">
      <li><a class="sideBarLink" href="z_WI.php">Walk-In</a></li>
      <li style="background-color:#02075d; font-size: 25px; color:white; padding:10px;">Walk-In Request</li>
...
if (isset($_SESSION['user_name'])) {
    ...
    $query = $con->prepare("SELECT * FROM walkin WHERE user_name = :username");
